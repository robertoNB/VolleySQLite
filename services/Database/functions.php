...
try{
	...
	$Cn = new PDO('mysql:host=localhost; dbname=bdalumno','root','');
...
function addStudent($data)
{
    ...
    $edad      =  $data['edad'];
    $sentencia = "INSERT INTO estudiante(noControl,nomEst,carrera,edad) VALUES ('$noControl','$nomEst','$carrera',$edad)";
